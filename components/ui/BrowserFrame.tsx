  ...
  return (
    <div
      className={[
        ...
        .join(" ")}
    >
      <div className="flex items-center gap-3 border-b border-subtle/25 bg-background px-3 py-2.5">
      ...
      <div
        className={[
          ...
          featured ? "aspect-[16/9] min-h-[280px] lg:min-h-[420px]" : "aspect-[16/10] min-h-[220px]",
        ].join(" ")}
      >
        {children}
      </div>
